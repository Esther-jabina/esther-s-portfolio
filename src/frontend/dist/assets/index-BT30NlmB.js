...
function About() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref, className: "max-w-4xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row gap-12 items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:w-1/3 flex-shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body font-semibold tracking-widest uppercase text-primary mb-3 block", children: "About Me" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-foreground leading-tight", children: "Who I Am" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 w-12 h-1 rounded-full bg-gradient-to-r from-primary to-accent" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:w-2/3 space-y-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-base sm:text-lg text-foreground/80 leading-relaxed", children: [
            "Dedicated and passionate web developer with a strong foundation in",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-semibold", children: "HTML and CSS" }),
            ", complemented by hands-on experience in",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-semibold", children: "Java" }),
            "."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-base sm:text-lg text-foreground/80 leading-relaxed", children: [
            "I thrive in collaborative environments and am committed to creating",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-semibold", children: "user-friendly, efficient, and visually appealing" }),
            " ",
            "web solutions that make a real impact."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 gap-4 pt-4", children: [
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body text-muted-foreground uppercase tracking-wide mb-1", children: label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-sm font-semibold text-foreground", children: value })
              ]
            },
            label
          )) })
...
const CERTS = [
  {
    ...
    issuer: "NPTEL",
    description: "Comprehensive course covering relational databases, SQL, normalization, transaction management, and query optimization.",
    badge: "DBMS",
    color: "primary"
  }
];
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body font-semibold tracking-widest uppercase text-primary mb-3 block", children: "Certifications" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-foreground", children: "Credentials & Courses" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 w-12 h-1 rounded-full bg-gradient-to-r from-primary to-accent mx-auto" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref, className: "flex justify-center", children: CERTS.map((cert, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1 bg-gradient-to-r from-primary to-accent" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8 flex gap-5 items-start", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-accent flex items-center justify-center shadow-elevated", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { className: "h-8 w-8 text-white" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body font-bold text-primary uppercase tracking-wider", children: cert.issuer }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-bold text-foreground mt-1 mb-2", children: cert.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground leading-relaxed", children: cert.description }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-block text-xs font-body font-semibold bg-primary/10 text-primary px-3 py-1 rounded-full border border-primary/20", children: [
                    cert.badge,
                    " Certified"
                  ] }) })
                ] })
...
function Contact() {
  ...
  reactExports.useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          const children = el.querySelectorAll("[data-contact]");
          let i = 0;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body font-semibold tracking-widest uppercase text-primary mb-3 block", children: "Contact" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-foreground", children: "Get in Touch" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 w-12 h-1 rounded-full bg-gradient-to-r from-primary to-accent mx-auto" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground mt-5 max-w-xl mx-auto text-sm sm:text-base", children: "I'm open to new opportunities and collaborations. Feel free to reach out!" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref, className: "grid sm:grid-cols-3 gap-5 max-w-2xl mx-auto", children: CONTACT_ITEMS.map((item) => {
          const inner = /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              "data-contact": true,
              "data-ocid": item.ocid,
              className: `bg-card border border-border rounded-xl p-7 flex flex-col items-center text-center shadow-xs transition-smooth group ${item.href ? "hover:shadow-hover hover:-translate-y-1 cursor-pointer hover:border-primary/30" : ""}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center mb-4 group-hover:bg-primary/20 transition-colors duration-200", children: item.icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground uppercase tracking-wide mb-1.5", children: item.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-sm font-semibold text-foreground group-hover:text-primary transition-colors duration-200 break-all", children: item.value })
              ]
            },
            item.label
          );
          return item.href ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            item.label
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "contents" }, children: inner }, item.label);
        }) })
      ] })
    }
  );
...
function Education() {
  ...
  reactExports.useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          const children = el.querySelectorAll("[data-edu]");
          let i = 0;
          for (const child of Array.from(children)) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body font-semibold tracking-widest uppercase text-primary mb-3 block", children: "Education" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-foreground", children: "Academic Background" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 w-12 h-1 rounded-full bg-gradient-to-r from-primary to-accent mx-auto" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-6 top-0 bottom-0 w-px bg-gradient-to-b from-primary/60 via-primary/20 to-transparent hidden sm:block" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-8", children: EDUCATION.map((edu, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              "data-edu": true,
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-4 top-6 w-5 h-5 rounded-full bg-primary border-4 border-background shadow-sm hidden sm:block" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-6 shadow-xs hover:shadow-elevated transition-smooth", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-3 mb-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body font-semibold text-primary uppercase tracking-wide", children: edu.type }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-bold text-foreground mt-1", children: edu.institution }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground text-sm mt-0.5", children: edu.degree })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right flex-shrink-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-1.5 text-xs font-body text-muted-foreground mb-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-3 w-3" }),
                        edu.period
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary/10 text-primary px-3 py-1 rounded-full text-sm font-display font-bold text-right", children: edu.score })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-muted-foreground text-xs font-body", children: [
...
function Experience() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body font-semibold tracking-widest uppercase text-primary mb-3 block", children: "Experience" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-foreground", children: "Work Experience" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 w-12 h-1 rounded-full bg-gradient-to-r from-primary to-accent mx-auto" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref, "data-ocid": "experience.item.1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl overflow-hidden shadow-elevated", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1 bg-gradient-to-r from-primary to-accent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start gap-4 justify-between mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "h-6 w-6 text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold text-foreground", children: "Web Developer Intern" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-primary font-semibold text-sm mt-0.5", children: "Klicknet Info Service Pvt. Ltd" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body font-semibold bg-accent/15 text-accent-foreground px-3 py-1 rounded-full border border-accent/30", children: "Internship" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-sm font-semibold text-foreground/70 uppercase tracking-wide mb-4", children: "Key Responsibilities" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: RESPONSIBILITIES.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "li",
              {
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs text-muted-foreground", children: [
          "© ",
          year,
          " Esther Jabina. All rights reserved."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs text-muted-foreground", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-primary/80 via-primary/50 to-accent/60" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/4 right-1/4 w-72 h-72 rounded-full bg-accent/20 blur-3xl pointer-events-none" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-1/3 left-1/5 w-56 h-56 rounded-full bg-primary/25 blur-2xl pointer-events-none" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body font-medium tracking-widest uppercase text-primary-foreground/80 mb-4", children: "Welcome to my portfolio" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-5xl sm:text-6xl md:text-7xl font-bold leading-tight mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-primary-foreground/90", children: "Hi, I'm" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: "block text-gradient-primary",
                    style: { WebkitTextFillColor: void 0 },
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        children: "Esther Jabina"
                      }
                    )
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-xl sm:text-2xl font-semibold text-primary-foreground/85 mb-3", children: "Web Developer" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base sm:text-lg text-primary-foreground/70 max-w-xl mx-auto leading-relaxed mb-10", children: "Dedicated and passionate developer with a strong foundation in HTML & CSS, crafting user-friendly, efficient, and visually appealing web solutions." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    ...
                    children: [
                      "Get in Touch",
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "ml-2 h-4 w-4" })
                    ]
                  }
                )
              ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 opacity-60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body text-primary-foreground/70 tracking-wider uppercase", children: "Scroll" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-10 bg-gradient-to-b from-primary-foreground/60 to-transparent" })
        ] })
      ]
    }
  );
...
function NavLink({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "a",
    {
      ...
      children: [
        label,
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-0.5 left-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full rounded-full" })
      ]
    }
  );
}
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 h-16 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              "Esther",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-primary", children: "." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex items-center gap-7", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { ...link }, link.href)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { open, onOpenChange: setOpen, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(SheetContent, { side: "right", className: "w-64 bg-card pt-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex flex-col gap-5 mt-4", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            NavLink,
            {
              ...link,
...
const PROJECTS = [
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CodeXml, { className: "h-6 w-6 text-primary" }),
    description: "A Java-based metro ticketing system that streamlines fare management and passenger experience.",
    tags: ["Java", "OOP", "CLI"],
    features: [
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Utensils, { className: "h-6 w-6 text-accent" }),
    description: "A responsive recipe management app with dynamic filtering, interactive components, and clean CSS design.",
...
function Projects() {
  ...
  reactExports.useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          const children = el.querySelectorAll("[data-proj]");
          let i = 0;
          for (const child of Array.from(children)) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body font-semibold tracking-widest uppercase text-primary mb-3 block", children: "Portfolio" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-foreground", children: "Featured Projects" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 w-12 h-1 rounded-full bg-gradient-to-r from-primary to-accent mx-auto" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref, className: "grid md:grid-cols-2 gap-7", children: PROJECTS.map((project, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            "data-proj": true,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1 bg-gradient-to-r from-primary to-accent" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-7 flex flex-col h-full", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-xl bg-primary/8 flex items-center justify-center", children: project.icon }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-bold text-foreground group-hover:text-primary transition-colors duration-200", children: project.title })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-foreground/70 leading-relaxed mb-5", children: project.description }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mb-5", children: project.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 mt-auto", children: project.features.map((feat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "li",
                  {
...
function Skills() {
  ...
  reactExports.useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          const children = el.querySelectorAll("[data-skill]");
          let i = 0;
          for (const child of Array.from(children)) {
    ...
    for (const child of Array.from(
      el.querySelectorAll("[data-skill]")
    )) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body font-semibold tracking-widest uppercase text-primary mb-3 block", children: "Technical Skills" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-foreground", children: "What I Work With" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 w-12 h-1 rounded-full bg-gradient-to-r from-primary to-accent mx-auto" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref, className: "grid grid-cols-2 sm:grid-cols-3 gap-5", children: SKILLS.map((skill, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            "data-skill": true,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl mb-3 block", children: skill.emoji }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-base text-foreground group-hover:text-primary transition-colors duration-200 mb-1", children: skill.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body text-muted-foreground leading-relaxed", children: skill.desc })
            ]
          },
          skill.name
        )) })
